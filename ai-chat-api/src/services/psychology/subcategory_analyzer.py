...
SUBCATEGORY_METADATA = {
    ...
    '2.2.2.6': {
        'name': '功能性/灵活性思维',
        'name_en': 'Functional/Flexible Thinking',
        'description': '适应性和功能性的思维模式',
        'high_activity': '功能性/灵活性思维活跃，你能够根据情境灵活调整思维方式，关注解决方案而非问题本身。这是认知健康的积极指标。',
        'low_activity': '功能性/灵活性思维较弱，你可能倾向于固定的思维模式，难以灵活应对变化。培养"这对我有用吗？"的思维习惯可能有帮助。'
    },
    ...
    '2.2.3.1.1': {
        'name': '自我视角',
        'name_en': 'Self Perspective',
        'description': '从自我角度理解和反思的能力',
        'high_activity': '自我视角能力强，你能够深入反思自己的想法、感受和行为动机，拥有良好的自我觉察能力。',
        'low_activity': '自我视角能力较弱，你可能较少关注自己的内在体验，或者难以清晰地理解自己的想法和感受。培养自我反思习惯可能有帮助。'
    },
    '2.2.3.1.2': {
        'name': '他人视角',
        'name_en': 'Others Perspective',
        'description': '从他人角度理解和共情的能力',
        'high_activity': '他人视角能力强，你能够设身处地理解他人的想法和感受，具有良好的共情和社交理解能力。',
        'low_activity': '他人视角能力较弱，你可能难以理解他人的立场和感受。练习"如果我是对方会怎么想"可能有帮助。'
    },
    '2.2.3.2': {
        'name': '空间视角转换',
    ...
    # 2.3.2 - Conflict Triggers
    '2.3.2.1': {
        'name': '存在感危机',
        'name_en': 'Existential Crisis',
        'description': '因存在感受到威胁而引发的冲突',
        'high_activity': '存在感危机触发点活跃，你可能在感到被忽视、不被看见或存在价值被否定时容易产生强烈的情绪反应和冲突。',
        'low_activity': '存在感危机触发较少，你对"被看见"的需求相对稳定，较少因存在感问题引发冲突。'
    },
    '2.3.2.2': {
        'name': '价值感危机',
        'name_en': 'Worth Crisis',
        'description': '因自我价值受到质疑而引发的冲突',
        'high_activity': '价值感危机触发点活跃，你可能在感到自己的能力、贡献或价值被否定时容易产生防御性反应和冲突。',
        'low_activity': '价值感危机触发较少，你对自我价值有较稳定的认知，较少因外界评价引发冲突。'
    },
    '2.3.2.3': {
        'name': '安全感危机',
        'name_en': 'Security Crisis',
        'description': '因安全感受到威胁而引发的冲突',
        'high_activity': '安全感危机触发点活跃，你可能在感到关系不稳定、被背叛或失去控制时容易产生焦虑和冲突行为。',
        'low_activity': '安全感危机触发较少，你在关系中有较强的安全感基础，较少因安全感问题引发冲突。'
    },
    '2.3.2.4': {
        'name': '自主权危机',
        'name_en': 'Autonomy Crisis',
        'description': '因自主权受到侵犯而引发的冲突',
        'high_activity': '自主权危机触发点活跃，你可能在感到被控制、被限制自由或个人边界被侵犯时容易产生强烈的反抗和冲突。',
        'low_activity': '自主权危机触发较少，你在关系中能够较好地平衡自主与依赖，较少因自主权问题引发冲突。'
    },

    # 2.3.3 - Empathy
    '2.3.3.1': {
        'name': '情绪共情',
        'name_en': 'Emotional Empathy',
        'description': '感受他人情绪的能力',
        'high_activity': '情绪共情能力强，你能够直觉地感受到他人的情绪状态，与他人产生情感共鸣。这让你成为敏感的倾听者，但也要注意情绪边界。',
        'low_activity': '情绪共情能力较弱，你可能较难直接感受到他人的情绪。这不代表你不关心他人，而是你可能更依赖认知理解而非情感感受。'
    },
    '2.3.3.2': {
        'name': '认知共情',
        'name_en': 'Cognitive Empathy',
        'description': '理解他人想法和立场的能力',
        'high_activity': '认知共情能力强，你能够理性地理解他人的想法、动机和立场，即使你不一定认同。这是有效沟通和冲突解决的重要能力。',
        'low_activity': '认知共情能力较弱，你可能难以从他人的角度理解问题。练习"换位思考"和主动倾听可能有帮助。'
    },
    '2.3.3.3': {
        'name': '行为共情',
        'name_en': 'Behavioral Empathy',
        'description': '将共情转化为支持行动的能力',
        'high_activity': '行为共情能力强，你不仅能感受和理解他人，还能将共情转化为实际的支持行动。你是可靠的支持者和帮助者。',
        'low_activity': '行为共情能力较弱，你可能感受到他人的需要但不确定如何回应。学习具体的支持技巧（如积极倾听、提供帮助）可能有帮助。'
    },
