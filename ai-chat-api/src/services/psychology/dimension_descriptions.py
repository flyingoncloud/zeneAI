...
DIMENSION_DESCRIPTIONS = {
    ...
    'internal_conflict': {
        'code': '2.4',
        'name_zh': 'MBTI性格类型',
        'name_en': 'MBTI Personality Type',
        'description': '基于MBTI四维度评估你的性格类型偏好：外向/内向(E-I)、感觉/直觉(S-N)、思考/情感(T-F)、判断/感知(J-P)。帮助你了解自己的认知风格和行为倾向。',
        'score_ranges': {
            'low': {
                'range': (0, 40),
                'label': '偏向灵活感性',
                'interpretation': '你的MBTI倾向偏向内向、直觉、情感和感知。你可能更注重内在体验、可能性探索、人际和谐和灵活应变。',
                'recommendations': [
                    '发挥直觉优势：利用你的想象力和创造力',
                    '平衡逻辑思维：在重要决策中加入客观分析',
                    '适度社交：在独处充电的同时保持社交连接',
            ...
            'medium': {
                'range': (41, 70),
                'label': '均衡型',
                'interpretation': '你的MBTI各维度较为均衡，能够在不同情境中灵活切换。这种适应性让你在多种场景下都能表现良好。',
                'recommendations': [
                    '识别优势：了解自己在哪些维度上更有优势',
                    '情境适应：根据不同场景发挥不同特质',
                    '深化自知：进一步探索自己的核心偏好',
            ...
            'high': {
                'range': (71, 100),
                'label': '偏向结构理性',
                'interpretation': '你的MBTI倾向偏向外向、感觉、思考和判断。你可能更注重外部互动、具体事实、逻辑分析和有序计划。',
                'recommendations': [
                    '发挥组织能力：利用你的计划性和执行力',
                    '培养同理心：在决策中更多考虑他人感受',
                    '留出独处时间：在社交之余给自己充电空间',
