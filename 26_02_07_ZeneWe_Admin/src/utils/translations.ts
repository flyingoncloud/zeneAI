...
export const translations = {
  ...
  zh: {
    ...
    sketch: {
      ...
      mockResult: "你的画作显示出能量线条与开放空间的平衡。左上角的圆������运动暗示着对连接的渴望，而下方的结构化线条表明你正在为思绪建立稳定的基础。你可能正感受到创造性的兴奋与对秩序需求的混合。"
    },
    test: {
      title: '内视快测',
    ...
    help: {
      ...
      items: [
        {
          trigger: '如何使用内视涂鸦',
          content: '内视涂鸦是 ZeneWe 中用来帮助你看见情绪的一种方式。你可以通过简单的绘画觉察当下的感受。这里没有对错，也不需要画得好看。只要如实表达，就已经足够。'
        },
        {
          trigger: '我不会画画，可以使用吗？',
        ...
        {
          trigger: '我的内容会被保存吗？',
          content: '会的。登录后，你的所有对话内容都会自动保存，方便你随时回来继续查看与生成报告。'
        },
        {
          trigger: '遇到问题怎么办？',
          content: '如果在使用中遇到问题或有反馈，请联系：zenet2026@gmail.com'
        }
      ]
    },
    userGuide: {
      ...
      sections: [
        {
          title: '什么是 ZeneWe',
          content: 'ZeneWe 是一个帮助你稳定情绪看见内在、生成清晰自我报告的自我觉察空间。你可以在这里：通过「情绪急救」快速从情绪漩涡中抽离，回到更清晰、更理性的状态；通过「内视涂鸦」把难以言说的感受呈现出来，帮你捕捉画面与情绪背后的线索；通过「内视快测」快速梳理关键维度，生成专属报告，帮助你更具体地理解自己。'
        },
        {
          title: '什么是 ZeneWe心知维？',
          content: 'ZeneWe心知维， 是一个帮你实现内视觉察的自我空间。你可以在这里：通过「情绪急救」快速从情绪漩涡中抽离，回到更清晰、更理性的状态；通过「内视涂鸦」把难以言说的感受呈现出来，帮你捕捉画面与情绪背后的线索；通过「内视快测」快速梳理内在自我的关键维度，生成专属内视觉察报告，帮助你更深度地理解自己、发展自己。ZeneWe心知维,遇见更好的自己！'
        },
        {
          title: '如何开始一次对话',
        ...
        {
          title: '关于记录与报告',
          content: '在使用过程中，ZeneWe 会帮助你整理你的表达，生成仅属于你的个人记录和内视觉察报告，用于你更好地理解自己。'
        },
        {
          title: '使用建议',
          list: [
    ...
    upgrade: {
      ...
      analyticsLockedDesc: '开通深度版后可查看情绪波动、��见标签与使用频率统计',
      remaining: '剩余',
      used: '已用',
      times: '次'
    }
